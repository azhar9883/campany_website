  ...
  import {FaFacebookF, FaTwitter, FaGooglePlusG, FaLinkedinIn, FaAnglesRight, FaGithub} from 'react-icons/fa'
...
function Footer() {
				...
				<div class="col-md-3 col-sm-4">
					<div class="footer-top-inner">
						...
						<ul class="footer-menu">
							<li><a href="index.html"><KeyboardDoubleArrowRightIcon sx={{ mr: "10px", fontSize: 17 }} /> Home</a></li>
							<li><a href="#"><KeyboardDoubleArrowRightIcon sx={{ mr: "10px", fontSize: 17 }} />Who We Are</a></li>
							<li><a href="#"><KeyboardDoubleArrowRightIcon sx={{ mr: "10px", fontSize: 17 }} />Contact Us</a></li>
							<li><a href="#"><KeyboardDoubleArrowRightIcon sx={{ mr: "10px", fontSize: 17 }} />Services</a></li>
							<li><a href="#"><KeyboardDoubleArrowRightIcon sx={{ mr: "10px", fontSize: 17 }} />Technology We Use</a></li>
							<li><a href="career.html"><KeyboardDoubleArrowRightIcon sx={{ mr: "10px", fontSize: 17 }} />Career</a></li>
							<li><a href="#"><KeyboardDoubleArrowRightIcon sx={{ mr: "10px", fontSize: 17 }} />Get A Quote</a></li>
						</ul>
						<h3>Get in touch!</h3>
						<div class="social-icon">			
							<a href="#" style={{background:"#3f589b"}}><FaFacebookF/></a> 
							<a href="#" style={{background:"#1e9ff3"}}><FaTwitter/></a> 
							<a href="#" style={{background:"#de4d3a"}}><FaGithub/></a> 
							<a href="#" style={{background:"#0376b5"}}><FaLinkedinIn/></a>										
						</div>
					</div>
				</div>
				<div class="col-md-5 col-sm-4">
					<div class="footer-top-inner">
						...
						<div class="contact-info">
							<p class="mar5"><FaMapMarkerAlt/> <strong>Address: </strong></p>
							...
							<p class="mar5"><strong><AiOutlineMail/> Email Address: </strong></p>
							<p><a href="mailto:info@minivetsystem.com">info@minivetsystem.com</a></p>
							<p class="mar5"><strong><IoIosCall/> Phone Number: </strong></p>
							<p class="font26"><a href="tel:033-4073-5131">033-4073-5131</a></p>
						</div>
					</div>
				</div>
			</div>
	...
	<span id="back-to-top" class="show"  onClick={scrollToTop}><img src="./assets/images/go-up.png" alt="no img"/></span>
</footer>
