                        ...
                        <div className="col-md-3 col-sm-4">
                            <div className="footer-top-inner">
                                ...
                                <ul className="footer-menu">
                                    <li><Link to="/#main"><KeyboardDoubleArrowRightIcon sx={{ mr: "10px", fontSize: 17 }} /> Home</Link></li>
                                    <li><Link to="/"><KeyboardDoubleArrowRightIcon sx={{ mr: "10px", fontSize: 17 }} />Who We Are</Link></li>
                                    <li><Link to="/contact"><KeyboardDoubleArrowRightIcon sx={{ mr: "10px", fontSize: 17 }} />Contact Us</Link></li>
                                    <li><Link to="/#service"><KeyboardDoubleArrowRightIcon sx={{ mr: "10px", fontSize: 17 }} />Services</Link></li>
                                    <li><Link to="/"><KeyboardDoubleArrowRightIcon sx={{ mr: "10px", fontSize: 17 }} />Technology We Use</Link></li>
                                    <li><Link to="/career"><KeyboardDoubleArrowRightIcon sx={{ mr: "10px", fontSize: 17 }} />Career</Link></li>
                                    <li><Link to="/projectEstimate"><KeyboardDoubleArrowRightIcon sx={{ mr: "10px", fontSize: 17 }} />Get A Quote</Link></li>
                                </ul>
                                <h3>Get in touch!</h3>
